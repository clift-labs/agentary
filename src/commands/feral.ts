    ...
    .action(async (key?: string) => {
        ...
        if (key) {
            ...
            try {
                ...
                console.log(chalk.gray('  Run `dobbie feral nodes` to see all available NodeCodes.\n'));
            }
        } else {
            // List all NodeCodes
    ...
    .action(async (key?: string) => {
        ...
        if (key) {
            ...
            try {
                ...
                console.log(chalk.gray('  Run `dobbie feral process` to see all available processes.\n'));
            }
        } else {
            // List all processes
